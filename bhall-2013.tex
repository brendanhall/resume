...
\cvline{Papers} {\begin{small}Over 20 publish papers. Multiple best-in-session and best- in-track awards\end{small}}
...
\section{\\ Interests}
\cvline{Memberships}{\begin{small}Member of IEEE, INCOSE, SAE\end{small}. Active SAE\ AS-2C and AS-2D\ committees }
\cvline{Community}{\begin{small}First League Lego Coach 2012,2013\end{small}}
\cvline{Hobbies}{\begin{small}Swimming, Music (Play Guitar)\end{small} }
